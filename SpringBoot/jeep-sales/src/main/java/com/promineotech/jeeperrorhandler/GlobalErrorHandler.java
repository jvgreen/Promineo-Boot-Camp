package com.promineotech.jeeperrorhandler;
...
public class GlobalErrorHandler {
  ...
  @ResponseStatus(code= HttpStatus.BAD_REQUEST)
  public Map<String, Object> handleConstrainViolateionExepction(
  ...
  public Map<String, Object> handleException(
     ...
     return createExceptionMessage(
         e, HttpStatus.INTERNAL_SERVER_ERROR, webRequest, LogStatus.STACK_TRACE);
  }
  ...
  public Map<String, Object> createExceptionMessage(
    ...
    if(logStatus == LogStatus.MESSAGE_ONLY) {
      log.error("Exeption: {}", e.getMessage().toString());
    }
    else {
